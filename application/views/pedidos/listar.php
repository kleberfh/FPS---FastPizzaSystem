    ...
    <div class="container-fluid page-body-wrapper">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <h4 class="col-md-8 card-title">Lista de pedidos</h4>
                        <?php echo form_open('pedidos/buscar', array('class' => 'col-md-4')) ?>
                        <input type="text" class="form-control" placeholder="Buscar Pedido" aria-label="search" aria-describedby="search" name="query">
                    </div>
