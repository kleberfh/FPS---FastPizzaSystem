                ...
                <div class="card-body">
                    ...
                    <?php echo form_open('clientes/registrar_cliente'); ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Nome" name="nome" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Telefone</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="telefone" name="telefone" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Cpf</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="cpf" name="cpf" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputConfirmPassword1">Rua</label>
                            <input type="text" class="form-control" id="exampleInputConfirmPassword1" placeholder="Rua" name="rua" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputConfirmPassword1">Numero</label>
                            <input type="text" class="form-control" id="exampleInputConfirmPassword1" placeholder="Numero" name="numero" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputConfirmPassword1">Bairro</label>
                            <input type="text" class="form-control" id="exampleInputConfirmPassword1" placeholder="Bairro" name="bairro" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputConfirmPassword1">Cep</label>
                            <input type="text" class="form-control" id="exampleInputConfirmPassword1" placeholder="Cep" name="cep" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputConfirmPassword1">Complemento</label>
                            <input type="text" class="form-control" id="exampleInputConfirmPassword1" placeholder="Complemento" name="complemento">
                        </div>
                        <button type="submit" class="btn btn-primary mr-2">Cadastrar</button>
                        <a class="btn btn-light" href="<?php echo base_url() ?>index.php/clientes">Cancelar</a>
                </div>
            </div>
        </div>
    </div>
